...
public static PetriNet CreateGenEx2() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
   ...
   d_Out.add(new ArcOut(d_T.get(0),d_P.get(0),1));
   d_Out.add(new ArcOut(d_T.get(0),d_P.get(1),1));
   PetriNet d_Net = new PetriNet("GenEx2",d_P,d_T,d_In,d_Out);
   PetriP.initNext();
   PetriT.initNext();
   ArcIn.initNext();
   ArcOut.initNext();
...
public static PetriNet CreateVerstat1() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
   ArrayList<PetriP> d_P = new ArrayList<>();
   ArrayList<PetriT> d_T = new ArrayList<>();
   ArrayList<ArcIn> d_In = new ArrayList<>();
   ArrayList<ArcOut> d_Out = new ArrayList<>();
   ...
   PetriNet d_Net = new PetriNet("Verstat1",d_P,d_T,d_In,d_Out);
   PetriP.initNext();
   PetriT.initNext();
   ArcIn.initNext();
   ArcOut.initNext();
...
public static PetriNet CreateVerstat2() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
   ArrayList<PetriP> d_P = new ArrayList<>();
   ArrayList<PetriT> d_T = new ArrayList<>();
   ArrayList<ArcIn> d_In = new ArrayList<>();
   ArrayList<ArcOut> d_Out = new ArrayList<>();
   ...
   d_Out.add(new ArcOut(d_T.get(1),d_P.get(5),1));
   d_Out.add(new ArcOut(d_T.get(2),d_P.get(6),1));
   PetriNet d_Net = new PetriNet("Verstat2",d_P,d_T,d_In,d_Out);
   PetriP.initNext();
   PetriT.initNext();
   ArcIn.initNext();
   ArcOut.initNext();
...
public static PetriNet CreateStash() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
   ArrayList<PetriP> d_P = new ArrayList<>();
   ArrayList<PetriT> d_T = new ArrayList<>();
   ArrayList<ArcIn> d_In = new ArrayList<>();
   ArrayList<ArcOut> d_Out = new ArrayList<>();
   ...
   d_Out.add(new ArcOut(d_T.get(1),d_P.get(1),1));
   d_Out.add(new ArcOut(d_T.get(2),d_P.get(1),1));
   PetriNet d_Net = new PetriNet("Stash",d_P,d_T,d_In,d_Out);
   PetriP.initNext();
   PetriT.initNext();
   ArcIn.initNext();
   ArcOut.initNext();
...
public static PetriNet CreateVerstat1Type2() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
   ArrayList<PetriP> d_P = new ArrayList<>();
   ArrayList<PetriT> d_T = new ArrayList<>();
   ArrayList<ArcIn> d_In = new ArrayList<>();
   ArrayList<ArcOut> d_Out = new ArrayList<>();
   ...
   d_Out.add(new ArcOut(d_T.get(2),d_P.get(6),1));
   PetriNet d_Net = new PetriNet("Verstat1Type2",d_P,d_T,d_In,d_Out);
   PetriP.initNext();
   PetriT.initNext();
   ArcIn.initNext();
   ArcOut.initNext();
...
public static PetriNet CreateVerstat2Type2() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
   ArrayList<PetriP> d_P = new ArrayList<>();
   ArrayList<PetriT> d_T = new ArrayList<>();
   ArrayList<ArcIn> d_In = new ArrayList<>();
   ArrayList<ArcOut> d_Out = new ArrayList<>();
   ...
   d_Out.add(new ArcOut(d_T.get(1),d_P.get(6),1));
   d_Out.add(new ArcOut(d_T.get(2),d_P.get(6),1));
   PetriNet d_Net = new PetriNet("Verstat2Type2",d_P,d_T,d_In,d_Out);
   PetriP.initNext();
   PetriT.initNext();
   ArcIn.initNext();
   ArcOut.initNext();
...
public static PetriNet CreateStashType2() throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
   ArrayList<PetriP> d_P = new ArrayList<>();
   ArrayList<PetriT> d_T = new ArrayList<>();
   ArrayList<ArcIn> d_In = new ArrayList<>();
   ArrayList<ArcOut> d_Out = new ArrayList<>();
   ...
   PetriNet d_Net = new PetriNet("StashType2",d_P,d_T,d_In,d_Out);
   PetriP.initNext();
   PetriT.initNext();
   ArcIn.initNext();
   ArcOut.initNext();
